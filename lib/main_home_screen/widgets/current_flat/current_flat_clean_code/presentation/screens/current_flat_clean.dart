...
class CurrentFlatClean extends StatelessWidget {
  ...
  Widget _buildCurrentFlat(CurrentFlatIntegration currentFlatIntegration,  context) {
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              currentFlatIntegration.data?.floor?.block?.apartment?.name ??
                                  'Unknown Apartment',
                              style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold),
                            ),
                            Row(
                              children: [
                                Text(
                                  currentFlatIntegration.data?.floor?.block?.apartment?.area ??
                                      'Unknown area',
                                  style: TextStyle(fontSize: 15),
                                ),
                                SizedBox(width: 10),
                                Text(
                                  currentFlatIntegration.data?.floor?.block?.apartment?.city ??
                                      'Unknown city',
                                  style: TextStyle(fontSize: 15),
                                ),
                              ],
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          Text(
                            currentFlatIntegration.data?.floor?.block?.name ?? 'Unknown Block',
                          ),
                        ],
                      ),
                    ),
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          Text(
                            currentFlatIntegration.data?.name ?? "Unknown Flat Number",
                          ),
                        ],
                      ),
                    ),
