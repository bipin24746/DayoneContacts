...
import 'package:dayonecontacts/main_home_screen/pages/login_pages/clean_code/data/models/otp_model/otp_response_model.dart';
...
class VerifyOtpRepoImpl extends OtpResponseRepo {
  ...
  Future<Either<Failure, OtpResponseModel>> verifyOtp({
    ...
    try {
      ...
      log('OTP verification failed: ${e.toString()}');
      return Left(Failure('Otp Verification Failed'));
    }
  }
}
